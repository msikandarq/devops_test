...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","E:\\custom-plugin");
    parameters.put("artifactId","custom-plugin");
    parameters.put("outputDirectory","E:\\custom-plugin\\target\\classes");
    parameters.put("testOutputDirectory","E:\\custom-plugin\\target\\test-classes");
